...
const UploadDropzone = ({ previewUrl, onFile, inputRef }) => {
  return (
    <div
      className="group relative border border-dashed border-2 rounded-xl h-52 flex items-center justify-center hover:border-primary/70 hover:bg-primary/5 overflow-hidden"
